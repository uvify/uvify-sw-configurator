    ...
    if (!crcError) {
        if (!dataHandler.unsupported) switch (code) {
            ...
            case MSPCodes.MSP_SONAR:
                ...
                break;
			case MSPCodes.MSP_SMARTBATTERY:
				SMARTBATTERY.smartbattery_enabled = data.readU8();
				SMARTBATTERY.percentage = data.readU16();
				SMARTBATTERY.temperature = parseFloat((data.readU16() / 100.0).toFixed(2));
				SMARTBATTERY.battery_state = data.readU8();
				break;
            case MSPCodes.MSP_ANALOG:
				...
				ANALOG.smartbattery_enabled = data.readU8();
                break;
