        ...
        function update_ui() {            
            ...
            for (var i = 0; i < MOTOR_DATA.length; i++) {
                ...
                $('.motor-' + i + ' .indicator', motors_wrapper).css({
                    ...
                    'height' : height + 'px',
                    'background-color' : 'rgba(0,156,224,1.'+ color +')'
                });
            }
            ...
            for (var i = 0; i < SERVO_DATA.length; i++) {
                ...
                $('.servo-' + i + ' .indicator', servos_wrapper).css({'margin-top' : margin_top + 'px', 'height' : height + 'px', 'background-color' : 'rgba(0,156,224,1.'+ color +')'});
            }
